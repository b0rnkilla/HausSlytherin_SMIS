...
/// <summary>
/// Einfacher Projekt-Logger mit taeglicher Textdatei im Dokumente-Ordner.
/// </summary>
public static class Logger
{
    ...
    /// <summary>
    /// Initialisiert den Logger im Standardordner "Dokumente\Logs".
    /// </summary>
    static Logger()
    {
    ...
    /// <summary>
    /// Gibt den Pfad der aktuellen Tages-Logdatei zurueck.
    /// </summary>
    public static string LogFilePath => BuildLogFilePath(DateTime.Now);

    /// <summary>
    /// Schreibt eine allgemeine Information in die Tages-Logdatei.
    /// </summary>
    ...
    /// <summary>
    /// Schreibt einen formatierten Logeintrag in die aktuelle Tagesdatei.
    /// </summary>
