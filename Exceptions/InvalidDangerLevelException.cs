...
{
    /// <summary> Wird ausgelöst, wenn eine Kreatur einen ungültigen Danger Level verwendet. </summary>
    public class InvalidDangerLevelException : Exception
    {
        /// <summary> Erstellt die Exception für einen ungültigen numerischen Danger Level.</summary>
